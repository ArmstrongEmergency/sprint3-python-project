...
# print names of all games
game_names = []
for columns in video_game_sales:
    game_names.append(columns[NAME])
print(game_names)

# Add a new game to the data set and lenght printed
...
print(dataset_info)
# tuples are better for this metadata because values in a tuple do not change while those in a list change.
