...
for columb in video_game_sales:
    total_global_sales = columb[9] + total_global_sales
avg_global_sales = total_global_sales / total_games
print(f"The Average of all games played are: {avg_global_sales}")

# % of Global sales of Wii Sports to Total Global Sales
